    ...
    return (
        <div className='flex lg:justify-around xl:flex-row 2sm:flex-col md:justify-center 2sm:justify-center md:items-center'>
            <div className="flex flex-col 2sm:mb-40 justify-center items-center" >
                <p className="font-inter font-semibold text-5xl w-[526px]  tracking-tighter mb-[24px] sm:text-center" >Everyone can be a chef in their own kitchen</p>
                <p className="font-inter font-normal text-base w-[526px] mb-[72px]" >Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </p>
            ...
            <div className='w-[651px] h-[500px] bg-gradient-to-b from-white to-blue-50 relative rounded-3xl'>
                <img className="absolute bottom-0 right-20 h-[597px] W-[660px]" src="images/cooker/image-220.png" alt="" />
