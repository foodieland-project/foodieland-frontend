    ...
    return (
        <div className='flex lg:justify-around xl:flex-row 2sm:flex-col md:justify-center 2sm:justify-center md:items-center'>
            <div className="flex flex-col mb-24 md:mb-40 justify-center items-center" >
                <p className="font-inter font-semibold text-4xl lg:text-5xl w-auto xl:w-[526px]  tracking-tighter mb-[24px] text-center xl:text-left" >Everyone can be a chef in their own kitchen</p>
                <p className="font-inter font-normal text-secondary text-sm md:text-base w-auto md:w-[526px] mb-[72px] text-center xl:text-left" >Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </p>
