...
const Blog = () => {
  ...
  return (
    ...
    <>
      ...
      <div className='w-full h-max  overflow-hidden h-max'>
        ...
        <section className='w-full h-full xl:flex  grid'>
          ...
          <article className=' xl:w-2/3 h-full   xl:h-[1250px]   h-[1500px] relative '>
            ...
            {currentPosts.map((item, index) => (
              ...
              <Link to={`/blog/${index + 1}`}> <article key={index} className='w-full  bg-white  flex hover:opacity-90 mb-3 transition-all  cursor-pointer'>
                ...
                <div className='xl:w-1/4 2sm:w-[250px] h-full bg-white flex justify-center align-center  '>
                  ...
                  <img src={`${item.img}`} alt="photo food" className='w-full h-full      rounded-[15px]' />
                </div>
                <div className='w-2/3 2sm:w-1/2 flex-col relative'>
                  <p className='font-bold m-1'>{item.title}</p>
                  <p className='text-gray-700 m-2 text-xs '>Lorem, ipsum dol Lorem ipsum dolor sit amet consectetur adipisicing elit. Et provident error repellendus tenetur omnis dolore laboriosam atque placeat odio voluptate.</p>
          ...
          <article className='xl:w-1/3 w-1/2  xl:h-[400px]  2sm:w-full    cursor-pointer '>
