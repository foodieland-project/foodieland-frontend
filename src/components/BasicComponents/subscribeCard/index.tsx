...
const SubscribeCard = () => {
  return (
    <section className=' w-full md:w-11/12 lg:w-full  mx-auto overflow-hidden rounded-[60px]    text-center bg-[#E7F9FD] my-10'>
      <div className='text-black flex flex-col items-center'>
        <div className='w-11/12 sm:w-[589px] sm:tracking-[-0.04em] mb-3 '>
          <h2 className='font-medium text-3xl sm:text-4xl lg:text-5xl mt-5 sm:mt-10 lg:mt-20 mb-3 md:mb-6 sm:leading-[58px]'>Deliciousness to your inbox</h2>
        </div>
      ...
      <div className='  flex justify-between items-center relative'>
        <form className='flex justify-center items-center w-11/12 sm:w-[480px]  sm:h-20 relative my-10 sm:mt-16 sm:mb-20 mx-auto rounded-3xl	bg-white'>
          <input type="email" name="email" placeholder='Your Email Address ...' className='subscribe-email-input w-full h-full pl-4 sm:pl-8 py-4 sm:py-8 rounded-2xl text-[17px] tracking-[-0.02em] leading-[17px] text-[rgba(0,0,0,0.4)]' />
