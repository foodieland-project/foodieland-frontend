...
const MoreRecipeCard = ({ recipeData }) => {
  ...
  return (
    <div className="flex flex-col lg:w-[24%] h-[316px] md:w-[46%] sm:w-3/5 mx-auto md:mx-0 md:justify-center my-2 rounded-3xl relative">
      <div className="xl:h-[200px] rounded-3xl">
        <img
          src={img}
          alt="product"
