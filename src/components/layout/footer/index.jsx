    ...
    <div>
      <div className="flex lg:flex-row  flex-col lg:justify-between mb-[75px] mt-[191px]  mx-[80px]">
        <div className="flex flex-col lg:items-start  items-center">
          ...
          <p className="flex justify-start text-center sm:text-left mb-[40px]">
      ...
      <div className="flex md:flex-row flex-col mb-[10px] h-[190px] justify-around md:justify-between items-center border-t mx-[80px] border-gray-300">
